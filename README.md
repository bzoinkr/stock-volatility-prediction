...
│  └─ predictions/     # json-file ready predictions of the target date
│
├─ artifacts/          # outputs (models, predictions, reports, evaluations)
│  ├─ reports/         # visuals of the data generated by vader and finbert
│  ├─ models/          # features of the model and its correlation
│  ├─ predictions/     # history of the models' predictions and their combined prediction
│  └─ evaluations/     # total evaluation of the models' predictions on multiple different dates
│
